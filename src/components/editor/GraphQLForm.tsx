...
export const GraphQLForm = memo<GraphQLFormProps>(({ initialData, onSubmit, isSubmitting = false, onCancel }) => {
  const {
    register,
    handleSubmit,
    control,
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-8">
              <label htmlFor="return_type" className="block text-sm font-medium text-gray-700 mb-1">
                Return Type *
              </label>
              <input
  ...
  const handleFormSubmit = useCallback(async (data: GraphQLAPIFormData) => {
    await onSubmit(data);
  }, [onSubmit]);
