            ...
            <div className="max-w-md w-full bg-card rounded-lg shadow-lg p-6 text-center">
              ...
              <div className="flex gap-2 justify-center">
                <button
                  ...
                  className="px-4 py-2 bg-primary text-primary-foreground text-sm rounded-lg hover:bg-primary/90 transition-colors focus:outline-none focus:ring-2 focus:ring-ring"
                >
                  Retry
                </button>
                <button
                  onClick={() => window.location.reload()}
                  className="px-4 py-2 bg-muted text-muted-foreground text-sm rounded-lg hover:bg-muted transition-colors focus:outline-none focus:ring-2 focus:ring-ring"
                >
                  Reload Page
                </button>
              </div>
